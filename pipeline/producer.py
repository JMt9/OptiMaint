...
class BearingFeaturesProducer:
    ...
    SLEEP_EVERY_N = 0         # si quieres “simular stream”, pon p.ej. 1000
    SLEEP_SECONDS = 0.0
    ...
    def _normalize_row(self, row: dict) -> dict:
        ...
        # Renombres “seguros”: si no existe la key, deja None
        ...
        # sublabel puede venir vacío; lo dejamos como "" o None (no importa para inferencia)
    ...
    def run(self) -> None:
        ...
        with open(self.INPUT_CSV_PATH, "r", newline="", encoding="utf-8") as f:
            ...
            # Check mínimo de columnas meta (para no empezar a enviar basura)
